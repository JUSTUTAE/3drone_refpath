...
public:
    ...
    {
        state_sub = nh_.subscribe<mavros_msgs::State>("uav2/mavros/state", 10, &OffboardController::stateCallback, this);
        ...
        ref_path_sub = nh_.subscribe<nav_msgs::Path>("uav2/ref_path", 10, &OffboardController::ref_pathCallback, this);
        ...
        set_point_pub = nh_.advertise<geometry_msgs::PoseStamped>("uav2/mavros/setpoint_position/local", 10);
    }
